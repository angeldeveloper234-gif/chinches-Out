                ...
                {rating >= 4 && (
                    <div className="animate-fade-in bg-green-50 p-8 rounded-2xl border border-green-100">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-2 bg-brand-green text-white font-bold py-4 px-8 rounded-xl shadow-lg hover:bg-brand-darkGreen transition-all hover:scale-105"
                        >
                    ...
                    <div className="animate-fade-in bg-orange-50 p-8 rounded-2xl border border-orange-100">
                        ...
                        <form onSubmit={handleFormSubmit} className="text-left space-y-4">
                            <div>
                                ...
                                <input required type="text" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-brand-green focus:border-transparent outline-none" placeholder="Juan Pérez" />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">¿Qué sucedió?</label>
                                <textarea required rows={4} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-brand-green focus:border-transparent outline-none" placeholder="Detalles de tu experiencia..." />
                            </div>
